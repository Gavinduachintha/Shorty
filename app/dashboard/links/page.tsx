...
export default function LinksPage() {
  return (
    <div className="mx-auto w-full max-w-6xl pt-5 pb-5">
      <Toaster
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="inline-flex items-center justify-between gap-2 rounded-md bg-[#8B5CF6] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#7C4DE8] active:bg-[#6D3FD9]">
          <span>Add Link</span>
      ...
      {/* table */}
      <div className="mt-4 overflow-hidden rounded-xl border border-[#2A2A2E] bg-[#131316]">
