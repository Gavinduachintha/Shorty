    ...
    <>
      <div className="flex h-screen">
        <div className="w-1/2 bg-black p-4 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-center text-blue-50 underline tracking-wide">
            Welcome Back
          </h1>
        </div>
            ...
            <form className="mt-8 space-y-6" action="#" method="post">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="mt-1 block w-full px-4 py-2 border border-gray-700 rounded-md shadow-sm foucs:ring-indigo-500 focus:border-ingigo-500 sm:text-sm"
                />
              </div>
              <div>
                <label
                ...
                <input
                  ...
                  type="password"
                  required
                  className="mt-1 block w-full px-4 py-2 border border-gray-700 rounded-md shadow-sm foucs:ring-ingigo-500 foucus:border-ingigo-500 sm:text-sm"
                />
              </div>
