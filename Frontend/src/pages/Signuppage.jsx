        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div>
              ...
              >
                Create your free account and unlock the power of professional
                link management with detailed analytics.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: "⚡", text: "Create unlimited short links" },
                { icon: "📊", text: "Advanced analytics & tracking" },
                { icon: "🔒", text: "Secure & privacy-focused" },
              ].map((benefit, i) => (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className={`w-full px-4 py-4 pl-12 pr-12 rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent ${
                          darkMode
                            ? "bg-gray-900/50 border-gray-600 text-gray-100 placeholder-gray-400"
                            : "bg-white border-gray-300 text-gray-900 placeholder-gray-500"
                        }`}
